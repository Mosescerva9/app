...
| 7 | Paper journal + paper ledger (full loop, no broker risk) | ❌ **stub only** |
...
**Exit rule:** `RESEARCH_COMPLETE` stays false after this PR because item 7 is a
stub and items 8–10 are deferred. Prefer `stand_aside` when evidence is thin.
